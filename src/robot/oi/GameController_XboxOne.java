...
public class GameController_XboxOne extends GameController {

	public GameController_XboxOne(int port) {
		super(port);
	}
	...
	public boolean getButtonRightBumper() 		{return joystick.getRawButton(6);}
	public boolean getButtonLeftBumper() 		{return joystick.getRawButton(5);}
	public boolean getButtonBack() 				{return joystick.getRawButton(7);}
	public boolean getButtonStart()				{return joystick.getRawButton(8);}
	public boolean getButtonThumbRight() 		{return joystick.getRawButton(10);}
	public boolean getButtonThumbLeft() 		{return joystick.getRawButton(9);}
